...
// CV Studio — the conversational, two-pane portfolio builder.
//   LEFT : upload / paste a CV → AI auto-build, quick controls, chat refine.
...
//
// ADDITIVE: the classic step builder at /dashboard/[id]/edit is untouched.
...
export default function BuildStudioPage() {
  ...
  const sections = templateKey === "creator" ? CREATOR_SECTIONS : GENERAL_SECTIONS;
        ...
        <div className="mx-auto w-full max-w-xl py-10">
          {loadingDoc ? (
            ...
            <>
              ...
              <p className="mt-6 text-center text-xs text-[var(--land-muted)]">
                {T("Prefer the classic step-by-step builder? ", "تفضّل البنّاء التقليدي؟ ")}
                <Link
                  href="/dashboard/new"
                  className="text-[var(--land-accent-hover)] underline"
                >
