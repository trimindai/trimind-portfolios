  ...
  return (
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-3 gap-6">
          <div>
            ...
            <div className="flex items-center gap-3">
              <input type="color" value={customization.primaryColor || "#18181b"} onChange={(e) => updateCustomization("primaryColor", e.target.value)} className="w-12 h-12 rounded-lg border border-slate-700 cursor-pointer bg-transparent" />
              <span className="text-xs text-slate-500 font-mono">{customization.primaryColor || "#18181b"}</span>
            </div>
            <p className="text-xs text-slate-600 mt-1">Headlines, text</p>
          </div>
          <div>
            <label className="text-sm font-medium text-slate-300 mb-2 block">Accent</label>
            <div className="flex items-center gap-3">
              <input type="color" value={customization.accentColor || "#1e3a5f"} onChange={(e) => updateCustomization("accentColor", e.target.value)} className="w-12 h-12 rounded-lg border border-slate-700 cursor-pointer bg-transparent" />
              <span className="text-xs text-slate-500 font-mono">{customization.accentColor || "#1e3a5f"}</span>
            </div>
            <p className="text-xs text-slate-600 mt-1">Skill tags, links</p>
          </div>
          <div>
            <label className="text-sm font-medium text-slate-300 mb-2 block">Background</label>
            <div className="flex items-center gap-3">
              <input type="color" value={customization.bgColor || "#ffffff"} onChange={(e) => updateCustomization("bgColor", e.target.value)} className="w-12 h-12 rounded-lg border border-slate-700 cursor-pointer bg-transparent" />
              <span className="text-xs text-slate-500 font-mono">{customization.bgColor || "#ffffff"}</span>
            </div>
      ...
      <div>
        ...
        <p className="text-sm text-slate-400 mb-4">Uncheck sections you want to hide. Empty sections are auto-hidden anyway.</p>
